...
class ResNet(nn.Module):
    def __init__(self, cfg=None, resnet_path=None):
    ...
    def initialize(self, resnet_path):
        self.load_state_dict(torch.load(resnet_path), strict=False)
...
class LDF(nn.Module):
    def __init__(self, cfg=None, resnet_path=None, model_path=None):
